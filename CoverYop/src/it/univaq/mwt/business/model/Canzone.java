...
public class Canzone implements Serializable {
	...
	public Canzone(int id, String titolo, float durata, String url, Album album,
			Scaletta scaletta) {
		super();
		this.id = id;
		this.titolo = titolo;
	...
	public Canzone(String titolo, float durata, String url, Album album, Scaletta scaletta) {
		super();
		this.titolo = titolo;
		this.durata = durata;
		this.url = url;
