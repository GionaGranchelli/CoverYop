		...
		<div class="container">
			...
			<div class="sidebar main-left main-medium">
				...
				<div class="gallery-3-col gallery-join">
					<span class="icon-wrap" style="float: left;">Foto Profilo</span>
					<br>
					<div class="photos">
						<img
							src="${pageContext.request.contextPath}/Local/image.html?id=${profilo}"
							alt="Image Title" class="immaginiModifica">
					</div>
				</div>
			</div>
				...
				<article>
					<div class="tabs-wrap">
						...
						<div class="tab-content" id="tab-photo">
							<form:form
								action="${pageContext.request.contextPath}/Privee/updateMultimedia/ProfileImage"
								method="POST" class="form contact-form"
								modelAttribute="formFotoProfilo" enctype="multipart/form-data">
							...
							<form:form
								action="${pageContext.request.contextPath}/Privee/updateMultimedia/AlbumPhoto"
								method="POST" class="form contact-form"
								modelAttribute="formFoto" enctype="multipart/form-data">
							...
							<c:forEach items="${albums.foto}" var="foto" varStatus="status">
								<div class="qualcosa">
									...
									<div class="photoDeleter">
										<a
											href="${pageContext.request.contextPath}/Privee/deletePhoto/${foto.id}">&nbsp;Cancella</a>
									</div>
								</div>
							</c:forEach>
							<!-- 									</div> -->
						...
						<div class="tab-content" id="tab-video">
							<form:form
								action="${pageContext.request.contextPath}/Privee/updateMultimedia/Video"
								method="POST" class="form contact-form"
							...
							<div class="details-meta" id="videoCollection">
								...
								<c:forEach items="${videos}" var="soundcloud">
									...
									<span style="float: right;"><a
										href="${pageContext.request.contextPath}/Privee/deleteVideo/${soundcloud.id}"><span
