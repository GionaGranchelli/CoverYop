		...
		<div class="container">
				...
				<div class="widget details-widget">
					...
					<div class="details-meta tab-content" id="details-meta">
						...
						<ul class="details-list">
							<li>
								<span class="label">Nome Locale</span>
								<div class="data"><b>${locale.nomeLocale}</b></div>
							</li>
							<li>
								<span class="label">Generi</span>
								<div class="data"> ${locale.categoria.nomeCat}</div>
							</li>
							<li>
								<span class="label">Address</span>
								<div class="data">${locale.indirizzo}</div>
							</li>
							<!-- start here -->
					</div>
					<security:authorize access="isAuthenticated()">	
			...
			<input type="submit"  class="action-button" value="Submit" />
					...
					<div class="details-meta">
						...
						<!-- Carousel slider -->
					<div id="blog-slider02" class="carousel-slider" data-effect="fadeUp" data-pagination="true" data-nav="true">
						<!-- Slide -->
				...
				<article>
					...
					<div id="blog-slider01" class="carousel-slider" data-effect="fadeUp" data-pagination="true" data-nav="true">
						...
						<c:forEach items="${slideshow}" var="slideshow">
							...
							<img src="${pageContext.request.contextPath}/${slideshow.url}" alt="Event Image">
					...
					<c:forEach items="${eventi}" var="eventi">
						<li>
							...
							<div class="lineup-artist"><a href="${pageContext.request.contextPath}/Event/${eventi.id}">${eventi.nome}</a> 
							<c:forEach items="${eventi.gruppo}" var="gruppo" > 
									<a class="gruppo" href="${pageContext.request.contextPath}/Group/${gruppo.id}/">&nbsp;/&nbsp;${gruppo.nomeGruppo}</a>
							</c:forEach></div>
						</li>
					</c:forEach>
					...
					<h2>Dove</h2>
					<div id="location-map" class="gmap map" data-address="${locale.indirizzo},${locale.citta} " data-zoom="18" data-zoom_control="true" data-scrollwheel="true"></div>
				</article>
				<!-- /article -->
