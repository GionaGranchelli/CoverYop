...
<!-- ############################# Ajax Page Container ############################# -->
<section id="page" data-title="You - How Does it Works">
	...
	<section class="content section">
		...
		<div class="container">
			...
			<article>
				...
				<div class="col-1-2">
					<img src="${pageContext.request.contextPath}/resources/placeholders/about-img01.jpg" alt="Noisa image" class="inline">
					<br>
					<!-- Buttons list -->
